...
export default function CDRange() {
    const { TID } = useParams();
    ...
    const [tType, setTType] = useState('DESCRIPTIVE RANGE');
    ...
    const handleSubmit = async (e) => {
      ...
      if(TID){
        try {
          ...
          if (response.ok) {
            console.log('Descriptive Test Updated successfully');
            setSuccessMessage('Descriptive Test Updated successfully.');
            setSelectedOption('');
            setTName('');
            setTCheck('');
            setISHeading('');
      ...
      try {
        ...
        if (response.ok) {
          console.log('Descriptive Test Created successfully');
          setSuccessMessage('Descriptive Test Created successfully.');
          setSelectedOption('');
          setTName('');
          setTCheck('');
          setISHeading('');
...
<div className='container mt-3 '>
  <div className='shadow-sm p-2 mb-2 bg-body-tertiary rounded'>
    <h6 className='text-center c2'>{TID ? 'Update Descriptive Test' : 'Create Descriptive Test'}</h6>
